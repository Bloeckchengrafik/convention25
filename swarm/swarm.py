...
class FtSwarmStepper(FtSwarmIO):
    ...
    async def set_speed(self, distance: int):
        await self._swarm.send(self._port_name, "setSpeed", distance)

    async def set_homing_offset(self, distance: int):
        await self._swarm.send(self._port_name, "setHomingOffset", distance)
